    ...
    def __init__(
        ...
        **kwargs,
        ...
        ignore_stereochemistry
            Determines which inchikey version will be used. If set to true the first 14 chars of the inchikey will be
            used.
        """
...
def _mols_to_fingerprints(
    ...
    **kwargs
    ...
    np.ndarray
        ...
        If the fingerprint for one molecule cannot be computed, the corresponding fingerprint will be a ndarray with
        zeroes.
    """
